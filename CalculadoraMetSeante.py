...
def main(rootin):
    ...
    rootin = Tk()
    #Interfaz gráfica
    rootin.title("Calculadora conversión de bases")
    rootin.geometry("1050x740")

    # Labels de la parte izquierda
    metodoLabel = Label(rootin, text="MÉTODO DE LA SECANTE", width="45", font=("helvetica", 12, "bold"),
                      padx=5, pady=5, bg="LightSkyBlue1", fg="black", borderwidth=2, relief="groove")
    metodoLabel.place(x=15, y=12)

    funcionLabel = Label(rootin, text="Función f(x)", width="17", font=("helvetica", 12, "bold"),
                         padx=5, pady=5, bg="ivory2", fg="black", borderwidth=2, relief="groove")
    funcionLabel.place(x=15, y=48)

    intervalLabel = Label(rootin, text="Intérvalo:", width="17", font=("helvetica", 11, "bold"),
                         padx=5, pady=5, fg="black")
    intervalLabel.place(x=15, y=80)

    inferiorLabel = Label(rootin, text="Límite inferior  a", width="17", font=("helvetica", 12, "bold"),
                         padx=5, pady=5, bg="ivory2", fg="black", borderwidth=2, relief="groove")
    inferiorLabel.place(x=15, y=108)

    superiorLabel = Label(rootin, text="Límite superior  b", width="17", font=("helvetica", 12, "bold"),
                       padx=5, pady=5, bg="ivory2", fg="black", borderwidth=2, relief="groove")
    superiorLabel.place(x=15, y=138)

    errorToleranciaLabel = Label(rootin, text="Error de tolerancia ET", width="17", font=("helvetica", 12, "bold"),
                             padx=5, pady=5, bg="ivory2", fg="black", borderwidth=2, relief="groove")
    ...
    raizLabel = Label(rootin, text="Raíz", width="17", font=("helvetica", 12, "bold"),
                         padx=5, pady=5, bg="ivory2", fg="black", borderwidth=2, relief="groove")
    raizLabel.place(x=15, y=270)

    errorRelativoLabel = Label(rootin, text="Error relativo", width="17", font=("helvetica", 12, "bold"),
                         padx=5, pady=5, bg="ivory2", fg="black", borderwidth=2, relief="groove")
    errorRelativoLabel.place(x=15, y=300)

    iteracionesLabel = Label(rootin, text="Número de iteraciones", width="17", font=("helvetica", 12, "bold"),
                         padx=5, pady=5, bg="ivory2", fg="black", borderwidth=2, relief="groove")
    iteracionesLabel.place(x=15, y=330)

    global tablaD, datosTabla, funcionEntry, limInferiorEntry, limSuperiorEntry, errorToleraEntry, raizVar, errorRelVar, numIterVar
    #Campos de texto
    ...
    funcionEntry = Entry(rootin, textvariable=funcionVar, font=10, width=30)
    funcionEntry.place(x=200, y=53)

    limInferiorEntry = Entry(rootin, textvariable=inferiorVar, font=10, width=30)
    limInferiorEntry.place(x=200, y=113)

    limSuperiorEntry = Entry(rootin, textvariable=superiorVar, font=10, width=30)
    limSuperiorEntry.place(x=200, y=143)

    errorToleraEntry = Entry(rootin, textvariable=errorTolerVar, font=10, width=30)
    errorToleraEntry.place(x=200, y=173)


    raizEntry = Entry(rootin, textvariable=raizVar, font=10, width=30, state="readonly")
    raizEntry.place(x=200, y=270)

    errorRelativoEntry = Entry(rootin, textvariable=errorRelVar, font=10, width=30, state="readonly")
    errorRelativoEntry.place(x=200, y=305)

    numIteracionesEntry = Entry(rootin, textvariable=numIterVar, font=10, width=30, state="readonly")
    numIteracionesEntry.place(x=200, y=335)


    # Botones

    btnCalcular = Button(rootin, text="Calcular", width="10", font=("helvetica", 12, "bold"),
                         bg="LightSkyBlue1", fg="black", command=calcular)
    btnCalcular.place(x=60, y=215)

    btnBorrar = Button(rootin, text="Borrar", width="10", font=("helvetica", 12, "bold"),
                       bg="LightSkyBlue1", fg="black", command=borrar)
    btnBorrar.place(x=200, y=215)

    btnSalir = Button(rootin, text="Salir", width="10", font=("helvetica", 12, "bold"),
                      bg="LightSkyBlue1", fg="black", command=lambda:salir(rootin))
    btnSalir.place(x=340, y=215)


    btnTabla = Button(rootin, text="Tabla", width="10", font=("helvetica", 12, "bold"),
    ...
    tablaD = ttk.Treeview(rootin, columns=columns, show='headings')
    ...
    scrollbar = ttk.Scrollbar(rootin, orient=tk.VERTICAL, command=tablaD.yview)
