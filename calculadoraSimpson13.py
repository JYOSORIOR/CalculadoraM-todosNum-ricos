...
# -------------------------------------------------------------------------------------------
    ventana = tkinter.Tk()
    ventana.title("Integración por Simpson 1/3")
    ventana.geometry("450x530")
    global valorAreaSalidaText, errorIntegralSalidaText,extremoDerText,numParticionesTexto,extremoIzqText,funcCampoTexto

    # Título
    integracionLabel = Label(ventana, text="Integración numérica por Simpson 1/3 ", width="40",
