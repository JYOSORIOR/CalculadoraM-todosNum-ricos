...
def borrar(decimalEntry,binariaEntry,octalEntry,hexadecimalEntry):
...
def pruebaParaLeerDatosDecimalCalcular(decimalEntry,binariaEntry,octalEntry,hexadecimalEntry):
    if decimalEntry.get() != "":
...
def main():
    ...
    btnCalcular = Button(root, text="Calcular", width="8", font=("helvetica", 12, "bold"),
                         bg="LightSkyBlue1", fg="black", command=lambda:pruebaParaLeerDatosDecimalCalcular(decimalEntry,binariaEntry,octalEntry,hexadecimalEntry))
    btnCalcular.place(x=80, y=190)

    btnBorrar = Button(root, text="Borrar", width="8", font=("helvetica", 12, "bold"),
                       bg="LightSkyBlue1", fg="black", command=lambda:borrar(decimalEntry,binariaEntry,octalEntry,hexadecimalEntry))
    ...
    borrar(decimalEntry,binariaEntry,octalEntry,hexadecimalEntry)