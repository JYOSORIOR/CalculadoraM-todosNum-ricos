...
from sympy import integrate, exp, sin, cos, pi, sqrt
...
def main(ventana):
    ...
    global valorAreaSalidaText, errorIntegralSalidaText, numParticionesTexto, extremoDerText, extremoIzqText, funcCampoTexto
    # Título
