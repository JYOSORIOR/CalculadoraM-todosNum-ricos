...
#np.arctan(2*x)+np.exp(-0.5*x)-2.5
...
#((sin(1.5-x))/(1.5-x))-(exp(-3.1415926*x))
# 50*ln(x)+5*x-160
...
def main(root):
    ...
    global funcionEntry, x0Entry, errorToleraEntry, raizVar, errorRelVar, numIterVar, tablaD, datosTabla
    # Campos de texto
